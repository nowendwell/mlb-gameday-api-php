...
function getScoreboard(){
	...
	if ($_GET["show"]){echo '<pre style="text-align:left">scoreboard<br />';print_r($scoreboard);echo"</pre>";}
	echo "<ul class='visible-desktop' id='scoreboard'>";
	if (is_array($scoreboard['data']['games']['game'][0])){
		foreach($scoreboard['data']['games']['game'] as $game){
			//if ($_GET["show"]){echo "<pre>";print_r($game);echo "</pre>";}
